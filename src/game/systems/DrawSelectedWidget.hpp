    ...
    struct DrawSelectedWidget : public ecs::System {
        ...
        void run(ecs::SystemData data) override final
        {
            for (auto [widget, pos] :
                ...
                if (widget.selected) {
                    raylib::shapes::Rectangle::draw({(pos.x - 2) / 100 * raylib::core::Window::getWidth(), (pos.y - 2) / 100 * raylib::core::Window::getHeight()}, {10, 10}, raylib::core::Color::YELLOW);
                    raylib::shapes::Rectangle::draw({(pos.x - 2) / 100 * raylib::core::Window::getWidth(), (pos.y - 2) / 100 * raylib::core::Window::getHeight()}, {8, 8}, raylib::core::Color::BLACK);
                }
            }
        }
    };
