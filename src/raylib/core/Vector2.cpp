...
namespace raylib
{
    namespace core
    {
        ...
        bool Vector2::operator==(const Vector2 &second) const { return (this->x == second.x && this->y == second.y); }

        bool Vector2::operator!=(const Vector2 &second) const { return !(*this == second); }
    } // namespace core
} // namespace raylib
